!(function (t, e) {
	...
	function nt(t, e) {
		return (
			void 0 === e && (e = "utf-8"), (e = e || "utf-8"), _().platform.encode(t, e)
		);
	}
	function rt(t, e) {
		return (
			void 0 === e && (e = "utf-8"), (e = e || "utf-8"), _().platform.decode(t, e)
		);
	}
	function ot(t, e, n) {
		if (0 === e) return 0;
	...
	function ut(t, e) {
		(this.backendTimer = t),
			null == (this.logger = e) && (this.logger = new ct());
	}
	var ct =
	...
	function ft(t, e, n) {
		return I(
			Array.isArray(t)
				? parseFloat(t[0].toFixed(ht)) + " + " + parseFloat(t[1].toFixed(ht)) + "j"
				: G(t)
				? "'" + t + "'"
				: "bool" === n
				? pt(t)
				: parseFloat(t.toFixed(ht)).toString(),
			e
		);
	}
	function pt(t) {
	...
	function xt(t, e, n) {
		var r = this;
		if (
			((this.dtype = e), (this.shape = t.slice()), (this.size = L(t)), null != n)
		) {
			var o = n.length;
	...
	var bt =
		...
		(wt.prototype.dispose = function () {
			this.isDisposed ||
				(mt().disposeTensor(this), (this.isDisposedInternal = !0));
		}),
							...
							if (1 < s)
								for (var c = 0; c < o / i; c++)
									for (var l = c * i, h = 0; h < i; h++)
										a[h] = Math.max(a[h], ft(u[l + h], 0, n).length);
							return a;
						})(t, e, n, o),
						a = e.length,
						s = (function t(e, n, r, o, i, a) {
							...
							if (20 < u) {
								...
								for (m.push("..."), g = u - 3; g < u; g++)
									(y = (x = g * v) + v),
										m.push.apply(m, t(e.slice(x, y), p, r, d, i, g === u - 1));
							} else
								for (g = 0; g < u; g++) {
									var x;
									(y = (x = g * v) + v),
		...
		(wt.prototype.gather = function (t, e) {
			return (
				void 0 === e && (e = 0), this.throwIfDisposed(), gt.gather(this, t, e)
			);
		}),
		...
		(wt.prototype.argMin = function (t) {
			return (
				void 0 === t && (t = null), this.throwIfDisposed(), gt.argMin(this, t)
			);
		}),
		(wt.prototype.argMax = function (t) {
			return (
				void 0 === t && (t = null), this.throwIfDisposed(), gt.argMax(this, t)
			);
		}),
		...
		(wt.prototype.leakyRelu = function (t) {
			return (
				void 0 === t && (t = 0.2), this.throwIfDisposed(), gt.leakyRelu(this, t)
			);
		}),
		...
		(wt.prototype.logSoftmax = function (t) {
			return (
				void 0 === t && (t = -1), this.throwIfDisposed(), gt.logSoftmax(this, t)
			);
		}),
		(wt.prototype.resizeBilinear = function (t, e) {
			return (
				void 0 === e && (e = !1),
				this.throwIfDisposed(),
				gt.image.resizeBilinear(this, t, e)
			);
		}),
		(wt.prototype.resizeNearestNeighbor = function (t, e) {
			return (
				void 0 === e && (e = !1),
				this.throwIfDisposed(),
				gt.image.resizeNearestNeighbor(this, t, e)
			);
		}),
		...
		(wt.prototype.depthwiseConv2D = function (t, e, n, r, o, i) {
			return (
				...
				void 0 === o && (o = [1, 1]),
				this.throwIfDisposed(),
				gt.depthwiseConv2d(this, t, e, n, r, o, i)
			);
		}),
		(wt.prototype.separableConv2d = function (t, e, n, r, o, i) {
			return (
				...
				void 0 === i && (i = "NHWC"),
				this.throwIfDisposed(),
				gt.separableConv2d(this, t, e, n, r, o, i)
			);
		}),
		...
		(wt.prototype.localResponseNormalization = function (t, e, n, r) {
			return (
				...
				void 0 === n && (n = 1),
				void 0 === r && (r = 0.5),
				gt.localResponseNormalization(this, t, e, n, r)
			);
		}),
		...
		(wt.prototype.stridedSlice = function (t, e, n, r, o, i, a, s) {
			return (
				...
				void 0 === s && (s = 0),
				this.throwIfDisposed(),
				gt.stridedSlice(this, t, e, n, r, o, i, a, s)
			);
		}),
	...
	var Ut,
		...
		Ht =
						...
						switch (t.label) {
							case 0:
								if (null == this.registryFactory[o])
									throw new Error("Backend name '" + o + "' not found in registry");
								return (
									(this.backendName = o),
			...
			(qt.prototype.runKernelFunc = function (n, o, t, i, a, s, u) {
				...
				null == i &&
					(i = null != this.state.activeScope ? this.state.activeScope.name : "");
				var f,
					...
					(f =
						null != m
							...
							: function () {
									...
									var e = Array.isArray(v) ? v : [v];
									return (
										c.shouldCheckForMemLeaks() && c.checkKernelForMemLeak(i, t, e), e
									);
							  }),
					this.scopedRun(
						function () {
			...
			(qt.prototype.gradients = function (t, o, i, e) {
				...
				return this.tidy("backward", function () {
					...
					(n[a.id] =
						null == i
							? ((e = Q(L((t = a.shape)), "float32")), Kt.makeTensor(e, t, "float32"))
							: i),
						(function (a, s) {
							for (
								var t = function (t) {
						...
						return (
							...
							e.runKernelFunc(
								function (t, e) {
									return (
										P(
											(i = r.apply(void 0, a.concat([e]))).value instanceof bt,
											function () {
		...
		t in ne ||
			(ne[t] = (function (e) {
				...
				return (
					...
					1 === e
						? t.getContext("webgl", re) || t.getContext("experimental-webgl", re)
						: t.getContext("webgl2", re)
				);
			})(t));
		var e = ne[t];
	...
	((ee = $t = $t || {})[(ee.DENSE = 0)] = "DENSE"),
		(ee[(ee.SHARED_BATCH = 1)] = "SHARED_BATCH"),
		((te = Jt = Jt || {})[(te.RENDER = 0)] = "RENDER"),
		(te[(te.UPLOAD = 1)] = "UPLOAD"),
		(te[(te.PIXELS = 2)] = "PIXELS"),
		(te[(te.DOWNLOAD = 3)] = "DOWNLOAD"),
		((Zt = Qt = Qt || {})[(Zt.UNPACKED_FLOAT16 = 0)] = "UNPACKED_FLOAT16"),
		(Zt[(Zt.UNPACKED_FLOAT32 = 1)] = "UNPACKED_FLOAT32"),
		(Zt[(Zt.PACKED_4X1_UNSIGNED_BYTE = 2)] = "PACKED_4X1_UNSIGNED_BYTE"),
		(Zt[(Zt.PACKED_2X2_FLOAT32 = 3)] = "PACKED_2X2_FLOAT32"),
		(Zt[(Zt.PACKED_2X2_FLOAT16 = 4)] = "PACKED_2X2_FLOAT16");
	function he(t) {
		return !!(
	...
	function Me(t) {
		...
		if (e !== t.FRAMEBUFFER_COMPLETE)
			throw new Error("Error binding framebuffer: " + Oe(t, e));
	}
	function Oe(t, e) {
		switch (e) {
	...
	function je(t) {
		if (0 === t) return 0;
		var e = ie(t);
		return Ke(e, "EXT_disjoint_timer_query_webgl2") && 2 === t
			? 2
			: Ke(e, "EXT_disjoint_timer_query")
			? 1
			: 0;
	}
	function Ke(t, e) {
	...
	function $e(t) {
		...
		if (1 === t)
			return (
				!!Ke(e, "OES_texture_float") && !!Ke(e, "WEBGL_color_buffer_float") && Je(e)
			);
	...
	function cn(t, e, n, r) {
		if ((void 0 === r && (r = "numeric"), t instanceof bt))
			return un(r, t.dtype, e, n), t;
		var o = j(t);
		if (
			("string" !== o && 0 <= ["bool", "int32", "float32"].indexOf(r) && (o = r),
			un(r, o, e, n),
			null == t ||
				(!z(t) &&
					!Array.isArray(t) &&
	...
	function xn(t, r) {
		...
		t.forEach(function (t, e) {
			...
			P(0 <= r && r < o, function () {
				return (
					"Error in concat" + o + "D: axis must be between 0 and " + (o - 1) + "."
				);
			});
		var i = t[0];
		t.forEach(function (t, e) {
	...
	tn.registerFlag("HAS_WEBGL", function () {
		...
		tn.registerFlag("WEBGL_DISJOINT_QUERY_TIMER_EXTENSION_RELIABLE", function () {
			return (
				0 < tn.getNumber("WEBGL_DISJOINT_QUERY_TIMER_EXTENSION_VERSION") &&
		...
		tn.registerFlag("WEBGL_RENDER_FLOAT32_ENABLED", function () {
			return (
				!tn.getBool("WEBGL_FORCE_F16_TEXTURES") &&
				tn.getBool("WEBGL_RENDER_FLOAT32_CAPABLE")
			);
		}),
				...
				function i(t) {
					...
					(e.next = function () {
						...
						return (
							...
							(e.z = e.w),
							(e.w = e.v),
							((e.d = (e.d + 362437) | 0) + (e.v = e.v ^ (e.v << 4) ^ t ^ (t << 1))) |
								0
						);
					}),
						(e.x = 0),
				...
				function i(t) {
					...
					(o.next = function () {
						...
						(function (t, e) {
							...
							for (n = 0; n < 8 && 0 === r[n]; ++n);
							for (8 == n ? (r[7] = -1) : r[n], t.x = r, t.i = 0, n = 256; 0 < n; --n)
								t.next();
						})(o, t);
				}
				function a(t, e) {
				...
				function i(t) {
					...
					(i.next = function () {
						...
						(function (t, e) {
							...
							for (
								128 <= o && (s[127 & ((e && e.length) || 0)] = -1), o = 127, i = 512;
								0 < i;
								--i
							)
								(r = s[(o + 34) & 127]),
			...
			((ur.prototype.nextValue = function () {
				...
				for (var e, n, r = !1; !r; ) {
					for (
						...
						1 <=
							(a =
								(o = 2 * this.random() - 1) * o + (i = 2 * this.random() - 1) * i) ||
						0 === a;
	...
	function sr(t, e, n, r) {
		...
		var o = r || Math.random();
		(this.randu = nr(o.toString())),
			(this.randn = new rr(0, 1, n, !1, this.randu())),
	...
	function cr(t, e, n) {
		return (
			void 0 === e && (e = "float32"), (e = e || "float32"), et(t), new vt(t, e, n)
		);
	}
	function lr(t, e) {
				...
				switch (t.label) {
					...
					case 2:
						for (o = t.sent(), i = new Set(o), c = a = 0; c < r.length; c++)
							i.has(r[c]) || a++;
						for (
							s = new vt([a], e.dtype), u = new vt([a], "int32"), l = c = 0;
							c < r.length;
							c++
						)
	...
	var fr = wn({
		...
		xr = wn({
			eye_: function (t, e, n, r) {
				...
				for (var o = cr([t, e], r), i = t <= e ? t : e, a = 0; a < i; ++a)
					o.set(1, a, a);
				...
				if (3 === n.length)
					return Or(yr(yr(yr(s, 0), 0), 0), [n[0], n[1], n[2], 1, 1]);
				throw new Error(
		...
		br = wn({
			multinomial_: function (t, e, n, r) {
				...
				if (i < 2)
					throw new Error(
						"Error in multinomial: you need at least 2 outcomes, but got " + i + "."
					);
				if (2 < a)
		...
		Sr = wn({
			randomNormal_: function (t, e, n, r, o) {
				...
				for (
					var i = new rr(e, n, r, !1, o), a = cr(t, r), s = 0;
					s < a.values.length;
					s++
				)
		...
		Dr = wn({
			randomGamma_: function (t, e, n, r, o) {
				if (
					...
					throw new Error("Unsupported data type " + r);
				for (
					var i = new or(e, n, r, o), a = cr(t, r), s = 0;
					s < a.values.length;
					s++
				)
					a.values[s] = i.nextValue();
		...
		Ar = wn({
			randomUniform_: function (t, e, n, r, o) {
				void 0 === e && (e = 0),
					...
					void 0 === r && (r = "float32");
				for (
					var i = cr(t, r), a = new ir(e, n, null, o), s = 0;
					s < i.values.length;
					s++
				)
							...
							x: function () {
								...
								if (1 === a.rank)
									...
									for (e = 0; e < s[0]; ++e)
										for (var n = 0; n < s[1]; ++n)
											t = t.add(
												i.slice([e * a.shape[0], n * a.shape[1]], [a.shape[0], a.shape[1]])
											);
								else if (3 === a.rank)
									for (e = 0; e < s[0]; ++e)
										for (n = 0; n < s[1]; ++n)
		...
		Pr = wn({
			truncatedNormal_: function (t, e, n, r, o) {
				if (
					...
					throw new Error("Unsupported data type " + r);
				for (
					var i = new rr(e, n, r, !0, o), a = cr(t, r), s = 0;
					s < a.values.length;
					s++
				)
					a.values[s] = i.nextValue();
	...
	function no(t, e) {
		for (var n = 0 < t.length ? t[t.length - 1] : 1, r = 0; r < t.length - 1; r++)
			n += t[r] * e[r];
		return n;
	}
	...
	function oo(t, e) {
		...
		var n = null != e;
		if (!n)
			for (var r in ((e = []), Kt.registeredVariables))
				e.push(Kt.registeredVariables[r]);
		var o = n
				? e.filter(function (t) {
						return !t.trainable;
				  })
	...
	function Ho(t, e, n, r) {
		for (
			...
			for (
				var h = l * s, f = t.subarray(h, h + s), p = [], d = 0;
				d < f.length;
				d++
			)
				p.push({ value: f[d], index: d });
			p.sort(function (t, e) {
											...
											return (function (t) {
												...
												if (c.length < e.length) {
													...
													return (
														...
														r +
														"(" +
														ai(["row", "col", "depth", "depth2", "depth3"], l) +
														");\n      }\n    "
													);
												}
												if (t.shapeInfo.isUniform)
											...
											return (function (t) {
												...
												if (i.length < e.length) {
													...
													return (
														...
														r +
														"(" +
														ai(["row", "col", "depth", "depth2", "depth3", "depth4"], a) +
														");\n      }\n    "
													);
												}
												var u = e[5],
	...
	function li(t, e, n, r, o, i) {
		...
		var s = "1.0";
		null != o &&
			(go(t, o), this.variableNames.push("scale"), (s = "getScaleAtOutCoords()")),
			(this.outputShape = t),
			(this.userCode =
	...
	function mi(t) {
		...
		for (n = 1; n < e.length; n++) {
			var o = e[n - 1];
			r.push(
				"else if (yC < " + e[n] + ") setOutput(getT" + n + "(yR, yC-" + o + "));"
			);
		}
		var i = e.length,
			a = e[e.length - 1];
	...
	var ya = Object.freeze({
		...
		xa =
			...
			(ba.prototype.createFloat32MatrixTexture = function (t, e) {
				return (
					this.throwIfDisposed(), ia(this.gl, this.debug, t, e, this.textureConfig)
				);
			}),
			(ba.prototype.createFloat16MatrixTexture = function (t, e) {
				return (
					this.throwIfDisposed(), aa(this.gl, this.debug, t, e, this.textureConfig)
				);
			}),
			(ba.prototype.createUnsignedBytesMatrixTexture = function (t, e) {
				return (
					this.throwIfDisposed(), sa(this.gl, this.debug, t, e, this.textureConfig)
				);
			}),
			...
			(ba.prototype.uploadDenseMatrixToTexture = function (t, e, n, r) {
				this.throwIfDisposed(),
					ha(this.gl, this.debug, t, e, n, r, this.textureConfig);
			}),
			(ba.prototype.createFloat16PackedMatrixTexture = function (t, e) {
				return (
					this.throwIfDisposed(), ca(this.gl, this.debug, t, e, this.textureConfig)
				);
			}),
			(ba.prototype.createPackedMatrixTexture = function (t, e) {
				return (
					this.throwIfDisposed(), ua(this.gl, this.debug, t, e, this.textureConfig)
				);
			}),
			(ba.prototype.deleteMatrixTexture = function (t) {
				...
				this.throwIfDisposed(),
					this.outputTexture === t &&
						(Fe(this.gl, this.debug, this.framebuffer), (this.outputTexture = null)),
					le(this.gl, this.debug, function () {
						return e.gl.deleteTexture(t);
					});
			}),
			(ba.prototype.downloadByteEncodedFloatMatrixFromOutputTexture = function (
				t,
				e,
				n
			) {
			...
			(ba.prototype.setProgram = function (t) {
				...
				this.throwIfDisposed(),
					...
					null != this.program &&
						this.debug &&
						we(this.gl, this.debug, this.program),
					le(this.gl, this.debug, function () {
			...
			(ba.prototype.getUniformLocation = function (t, e, n) {
				return (
					void 0 === n && (n = !0),
					this.throwIfDisposed(),
					n ? De(this.gl, this.debug, t, e) : Ae(this.gl, t, e)
				);
			}),
			...
			(ba.prototype.setInputMatrixTexture = function (t, e, n) {
				this.throwIfDisposed(),
					...
					Te(this.gl, this.debug, this.program, t, e, n);
			}),
			...
			(ba.prototype.bindTextureToFrameBuffer = function (t) {
				this.throwIfDisposed(),
					Ne(this.gl, this.debug, t, this.framebuffer),
					this.debug && Me(this.gl);
			}),
			(ba.prototype.unbindTextureToFrameBuffer = function () {
				null != this.outputTexture
					? (Ne(this.gl, this.debug, this.outputTexture, this.framebuffer),
					  this.debug && Me(this.gl))
					: Fe(this.gl, this.debug, this.framebuffer);
			}),
	...
	function ba(t) {
		...
		if (1 === _().getNumber("WEBGL_VERSION")) {
			if (
				((this.textureFloatExtension = pe(
					this.gl,
					this.debug,
					"OES_texture_float"
				)),
				Ke(this.gl, "OES_texture_half_float"))
			)
				this.textureHalfFloatExtension = pe(
					this.gl,
					this.debug,
			...
			if (
				...
				Ke(this.gl, "EXT_color_buffer_half_float"))
			)
				this.colorBufferHalfFloatExtension = pe(
					this.gl,
					this.debug,
		...
		} else if (((n = "EXT_color_buffer_float"), Ke(this.gl, n)))
			this.colorBufferFloatExtension = this.gl.getExtension(n);
		else {
			if (!Ke(this.gl, "EXT_color_buffer_half_float"))
				throw new Error("GL context does not support color renderable floats");
			this.colorBufferHalfFloatExtension = this.gl.getExtension(
				"EXT_color_buffer_half_float"
			);
		}
		(this.vertexBuffer = na(this.gl, this.debug)),
			(this.indexBuffer = ra(this.gl, this.debug)),
			(this.framebuffer = Re(this.gl, this.debug)),
			(this.textureConfig = ce(this.gl, this.textureHalfFloatExtension));
	}
	function wa(t, s) {
	...
	function qa(i, a) {
		...
		function l(o) {
			...
			return (
				"getChannel(getX(" + t.join(",") + "), vec2(" + t.slice(-2).join(",") + "))"
			);
		}
		this.userCode =
			1 === t
	...
	function Xa(t, e, n) {
		...
		if (1 === n) r = o = "resRC";
			...
			for (
				var i = ["resRC.x", "resRC.y", "resRC.z", "resRC.w"], a = [], s = [], u = 0;
				u < e.length;
				u++
			)
	...
	function Ja(t) {
		...
		(e =
			...
			t
				.map(function (t, e) {
					return (
						"sourceLoc." + $a[e] + " = start[" + e + "] + coords." + $a[e] + ";"
					);
				})
				.join("\n") +
			"\n      "),
	...
	function rs(t, e) {
		...
		if (t === Jt.RENDER || null == t)
			return (
				(n = e),
				_().getBool("WEBGL_RENDER_FLOAT32_ENABLED")
					? n
						? Qt.PACKED_2X2_FLOAT32
						: Qt.UNPACKED_FLOAT32
					: n
					? Qt.PACKED_2X2_FLOAT16
					: Qt.UNPACKED_FLOAT16
			);
		var n;
	...
	var Ds,
		As =
			...
			(Ts.prototype.write = function (t, e, n) {
				...
				var r = {};
				return (
					this.texData.set(r, { shape: e, dtype: n, values: t, usage: Jt.UPLOAD }), r
				);
			}),
			(Ts.prototype.move = function (t, e, n, r) {
				if (
					(_().getBool("DEBUG") && this.checkNumericalProblems(e), "complex64" === r)
				)
					throw new Error(
						"Cannot write to a complex64 dtype. Please use tf.complex(real, imag)."
					);
			...
			(Ts.prototype.readSync = function (t) {
				...
				return (
					...
					(f =
						"complex64" === r
							? Mo(o.real.dataSync(), o.imag.dataSync())
							: this.getValuesFromTexture(t)),
					p && (this.downloadWaitMs += tt() - h),
						...
						switch (t.label) {
							case 0:
								...
								if (
									...
									return (
										(c = u ? new cs(o, Es) : new us(o, Es)),
										(l = this.runWebGLProgram(c, [{ dataId: E, shape: o, dtype: a }], a)),
								...
								return (
									...
									"complex64" !== a &&
										...
										(f = (C = this.gpgpu).createBufferFromTexture.apply(
											C,
											[d.texture].concat(se(o))
										))),
									this.pendingRead.set(E, []),
									"complex64" === a ? [3, 2] : [4, this.gpgpu.createAndWaitForFence()]
								);
							case 1:
								t.sent(), (t.label = 2);
							case 2:
							...
							case 4:
								(v =
									null == f
										...
										: ((x = L(o)), this.gpgpu.downloadFloat32MatrixFromBuffer(f, x))),
									(t.label = 5);
							case 5:
								return (
						...
						switch (t.label) {
							case 0:
								return (
									...
									0 < _().getNumber("WEBGL_DISJOINT_QUERY_TIMER_EXTENSION_RELIABLE")
										? [4, Promise.all(o)]
										: [3, 2]
								);
							case 1:
			...
			(Ts.prototype.startTimer = function () {
				return 0 < _().getNumber("WEBGL_DISJOINT_QUERY_TIMER_EXTENSION_RELIABLE")
			...
			(Ts.prototype.getCPUBackend = function () {
				return _().getBool("WEBGL_CPU_FORWARD")
					? (null == this.cpuBackend && (this.cpuBackend = Kt.findBackend("cpu")),
					  this.cpuBackend)
					: null;
			}),
			...
			(Ts.prototype.multiply = function (t, e) {
				...
				if (_().getBool("WEBGL_PACK_BINARY_OPERATIONS"))
					return this.packedBinaryOp(t, e, bi, t.dtype);
			...
			(Ts.prototype.segOpCompute = function (t, e, n, r, o) {
				var i = t.shape[0],
					...
					s = (function (t, e) {
						var n,
							r = !1;
						for (
							t <= 30 ? ((n = t), (r = !0)) : (n = X(t, Math.floor(Math.sqrt(t))));
							!r;
				...
				return c.shape[1] === o
					? c
					: ((n = Wn(0, o).tile([a / s])), this.segOpCompute(c, e, n, r, o));
			}),
			(Ts.prototype.argMinMaxReduce = function (t, e, n) {
				var r = [e];
				if (
					(vn("arg" + n.charAt(0).toUpperCase() + n.slice(1), r, t.rank),
			...
			(Ts.prototype.subtract = function (t, e) {
				if ("complex64" === t.dtype && "complex64" === e.dtype)
					return this.complexSeparableBinaryOp(t, e, xi);
				if (this.shouldExecuteOnCPU([t, e])) return this.cpuBackend.subtract(t, e);
				var n = Pt(t.dtype, e.dtype);
				if (_().getBool("WEBGL_PACK_BINARY_OPERATIONS"))
					return this.packedBinaryOp(t, e, xi, t.dtype);
			...
			(Ts.prototype.exp = function (t) {
				...
				if (_().getBool("WEBGL_PACK_UNARY_OPERATIONS"))
					return this.packedUnaryOp(t, ws, t.dtype);
			...
			(Ts.prototype.expm1 = function (t) {
				...
				if (_().getBool("WEBGL_PACK_UNARY_OPERATIONS"))
					return this.packedUnaryOp(t, Cs, t.dtype);
			...
			(Ts.prototype.prelu = function (t, e) {
				var n = _().getBool("WEBGL_PACK_BINARY_OPERATIONS")
					? new di(Ci, t.shape, e.shape)
					: new pi(wi, t.shape, e.shape);
				return this.compileAndRun(n, [t, e]);
			}),
			(Ts.prototype.elu = function (t) {
				if (_().getBool("WEBGL_PACK_UNARY_OPERATIONS"))
					return this.packedUnaryOp(t, Rs, t.dtype);
			...
			(Ts.prototype.eluDer = function (t, e) {
				var n = _().getBool("WEBGL_PACK_BINARY_OPERATIONS")
					...
					: new pi("return (b >= 1.0) ? a : a * (b + 1.0);", t.shape, e.shape);
				return this.compileAndRun(n, [t, e]);
			}),
			...
			(Ts.prototype.fusedDepthwiseConv2D = function (t) {
				...
				return (
					h && l.push(i),
					f && l.push(s),
					(e = u ? new Bi(o, h, c, f) : new Pi(o, h, c, f)),
			...
			(Ts.prototype.reshape = function (t, e) {
				var n = this.texData.get(t.dataId);
				if (!n.isPacked || Ge(t.shape, e) || (null !== n.texture && Ge(n.shape, e)))
					return To(t, e);
			...
			(Ts.prototype.resizeBilinear = function (t, e, n, r) {
				var o = _().getBool("WEBGL_PACK_IMAGE_OPERATIONS")
					? new Ua(t.shape, e, n, r)
					: new za(t.shape, e, n, r);
			...
			(Ts.prototype.nonMaxSuppression = function (t, e, n, r, o) {
				return (
					...
					Bo(t.dataSync(), e.dataSync(), n, r, o)
				);
			}),
			...
			(Ts.prototype.runWebGLProgram = function (o, t, e, n, r) {
				...
				if (
					(o.packedOutput && (s.isPacked = !0), o.outPackingScheme === $t.DENSE)
				) {
				...
				if ((null != o.outTexUsage && (s.usage = o.outTexUsage), 0 === L(a.shape)))
				...
				var c = [],
					l = t.map(function (t) {
						...
						return (
							i.uploadToGPU(t.dataId), { shape: t.shape, texData: e, isUniform: !1 }
						);
					});
					...
					d = this.getAndSaveBinary(p, function () {
						return (function (t, r, e, n) {
							...
							for (var f = {}, p = 0; p < r.variableNames.length; p++) {
								...
								(f[d] = t.getUniformLocation(c, d, !1)),
									(f["offset" + d] = t.getUniformLocation(c, "offset" + d, !1));
							}
							return {
								program: r,
								source: u,
			...
			(Ts.prototype.getAndSaveBinary = function (t, e) {
				return (
					t in this.binaryCache || (this.binaryCache[t] = e()), this.binaryCache[t]
				);
			}),
			...
			(Ts.prototype.uploadToGPU = function (t) {
				...
				if (null == a) {
					...
					if ((null == h && ((h = Ue(r, u)), (n.texShape = h)), null != i)) {
						...
						p = u
							? ((d = (e = ue(h[0], h[1]))[0]), (v = e[1]), new Ki(f, [v, d], m))
							: new ji(f, [v, d], m);
						var g = this.makeTensorInfo([v, d], o);
						(this.texData.get(g.dataId).usage = m ? Jt.PIXELS : Jt.UPLOAD),
				...
				return (
					...
					null != e &&
						(n.values = (function (t, e) {
							...
							for (
								var n =
										"int32" === e ? new Int32Array(t.length) : new Uint8Array(t.length),
									r = 0;
								r < n.length;
								++r
							)
		...
		return y(this, void 0, void 0, function () {
			...
			return R(this, function (t) {
				switch (t.label) {
					...
					case 1:
						return (
							(n = t.sent()), (r = qo(e.shape, n)), o !== e && e.dispose(), [2, r]
						);
				}
			});
		});
	...
	var Cu = wn({
		...
		ac = wn({
			greaterEqualStrict_: function (t, e) {
				...
				return (
					x(n.shape, r.shape, "Error in greaterEqualStrict: "), n.greaterEqual(r)
				);
			},
		}),
		sc = wn({
	...
	function xc(t, e, r, o, i, a, s) {
		...
		3 === e.rank &&
			...
			P(4 === r.rank, function () {
				return (
					"Error in conv2dDerInput: filter must be rank 4, but got rank " + r.rank
				);
			});
	...
	var Cc = wn({
			conv1d_: function (t, e, n, r, o, i, a) {
				...
				2 === s.rank && ((l = !0), (c = s.as3D(1, s.shape[0], s.shape[1]))),
					...
					P(3 === u.rank, function () {
						return (
							"Error in conv1d: filter must be rank 3, but got rank " + u.rank + "."
						);
					}),
					null != a &&
						P(B(r), function () {
		...
		Ec = wn({
			conv2d_: function (t, e, i, a, s, u, n) {
				...
				3 === r.rank &&
					...
					P(4 === o.rank, function () {
						return (
							"Error in conv2d: filter must be rank 4, but got rank " + o.rank + "."
						);
					}),
					null != n &&
						P(B(a), function () {
		...
		_c = wn({
			conv3d_: function (t, e, o, i, n, a) {
				...
				4 === s.rank &&
					...
					P(5 === c.rank, function () {
						return (
							"Error in conv3d: input must be rank 5, but got rank " + c.rank + "."
						);
					}),
					P(5 === u.rank, function () {
						return (
							"Error in conv3d: filter must be rank 5, but got rank " + u.rank + "."
						);
					}),
							...
							return {
								...
								$filter: function () {
									return (function (t, e, n, r, o) {
										var i = t;
										4 === t.rank &&
											(i = t.as5D(1, t.shape[0], t.shape[1], t.shape[2], t.shape[3]));
										var a = e;
										4 === a.rank &&
											(a = e.as5D(1, e.shape[0], e.shape[1], e.shape[2], e.shape[3])),
											P(5 === i.rank, function () {
		...
		Tc = wn({
			conv2dTranspose_: function (t, e, n, r, o, i) {
				return xc(
					n,
					cn(t, "x", "conv2dTranspose"),
					cn(e, "filter", "conv2dTranspose"),
					r,
					o,
					"NHWC",
					i
		...
		Nc = wn({
			conv3dTranspose_: function (t, e, n, r, o) {
				return wc(
					n,
					cn(t, "x", "conv3dTranspose"),
					cn(e, "filter", "conv3dTranspose"),
					r,
					o
				);
			},
	...
	function Uc(t, r, o, i, a, e) {
		...
		if (1 === c.filterWidth && 1 === c.filterHeight && A(c.inShape, c.outShape))
			return n.clone();
		var l = [s],
			h = Kt.runKernelFunc(
				function (t, e) {
							...
							return {
								x: function () {
									return (function (t, e, n, r, o, i, a, s) {
										...
										4 === c.rank &&
											((d = !0),
											(h = u.as5D(1, u.shape[0], u.shape[1], u.shape[2], u.shape[3])),
											(f = c.as5D(1, c.shape[0], c.shape[1], c.shape[2], c.shape[3])),
											(p = l.as5D(1, l.shape[0], l.shape[1], l.shape[2], l.shape[3]))),
											P(5 === h.rank, function () {
												return (
	...
	var tl = wn({
			...
			norm_: function (t, e, n, r) {
				...
				var o = (function t(e, n, r) {
						...
						if (
							...
							if ("euclidean" === n || 2 === n)
								return e.abs().pow(kn(2, "int32")).sum(r).sqrt();
		...
		wl = wn({
			multiRNNCell_: function (t, e, n, r) {
				for (
					var o = cn(e, "data", "multiRNNCell"),
						i = ln(n, "c", "multiRNNCell"),
						a = ln(r, "h", "multiRNNCell"),
						s = o,
						u = [],
						c = 0;
					c < t.length;
		...
		El = wn({
			stridedSlice_: function (t, e, n, r, o, i, a, s, u) {
				...
				for (var f = 0; f < c.rank; f++)
					(e[f] = Zr(o, e, r, c.shape, f)),
						(n[f] = to(i, n, r, c.shape, f)),
						(r[f] = r[f] || 1);
				var p = Jr(u);
			...
			rfft_: function (t, e) {
				...
				if (null != e && e < r) {
					...
					(s[t.shape.length - 1] = e - r),
						(n = t.concat(Pn(s), t.shape.length - 1)),
						(r = e);
				} else n = t;
				var u = n.zerosLike(),
					c = Cn(n, u).as2D(o, r),
					...
					switch (t.label) {
						...
						case 2:
							for (
								...
								for (
									h = l * u, f = o.subarray(h, h + u), p = [], d = 0;
									d < f.length;
									d++
								)
									p.push({ value: f[d], index: d });
		...
		Vl = wn({
			stft_: function (t, e, n, r, o) {
				...
				void 0 === o && (o = Wl),
					null == r &&
						((i = e),
						(r = Math.floor(Math.pow(2, Math.ceil(Math.log(i) / Math.log(2))))));
				for (
					var a = Ul(t, e, n), s = Yu(a, o(e)), u = [], c = 0;
					c < a.shape[0];
					c++
				)
					u.push(Sl(s.slice([c, 0], [1, e]), r));
				return Vn(u);
			},
		}),
		Gl = Object.freeze({
	...
	((Ll = Bl = Bl || {})[(Ll.NONE = 0)] = "NONE"),
		(Ll[(Ll.MEAN = 1)] = "MEAN"),
		(Ll[(Ll.SUM = 2)] = "SUM"),
		(Ll[(Ll.SUM_BY_NONZERO_WEIGHTS = 3)] = "SUM_BY_NONZERO_WEIGHTS");
	var Hl = wn({
			absoluteDifference_: function (t, e, n, r) {
				...
				var o = cn(t, "labels", "absoluteDifference"),
					...
					a = null;
				null != n && (a = cn(n, "weights", "absoluteDifference")),
		...
		jl = wn({
			cosineDistance_: function (t, e, n, r, o) {
				...
				var i = cn(t, "labels", "cosineDistance"),
					...
					s = null;
				null != r && (s = cn(r, "weights", "cosineDistance")),
		...
		Kl = wn({
			hingeLoss_: function (t, e, n, r) {
				...
				var o = cn(t, "labels", "hingeLoss"),
					...
					a = null;
				null != n && (a = cn(n, "weights", "hingeLoss")),
		...
		Xl = wn({
			huberLoss_: function (t, e, n, r, o) {
				...
				var i = cn(t, "labels", "huberLoss"),
					...
					s = null;
				null != n && (s = cn(n, "weights", "huberLoss")),
		...
		$l = wn({
			meanSquaredError_: function (t, e, n, r) {
				...
				var o = cn(t, "labels", "meanSquaredError"),
					...
					a = null;
				null != n && (a = cn(n, "weights", "meanSquaredError")),
		...
		Jl = wn({
			sigmoidCrossEntropy_: function (t, e, n, r, o) {
				...
				var s = cn(t, "multiClassLabels", "sigmoidCrossEntropy"),
					...
					a = null;
				if (
					(null != n && (a = cn(n, "weights", "sigmoidCrossEntropy")),
		...
		Ql = wn({
			softmaxCrossEntropy_: function (t, e, n, r, o) {
				...
				var i = cn(t, "onehotLabels", "softmaxCrossEntropy"),
					...
					s = null;
				if (
					(null != n && (s = cn(n, "weights", "softmaxCrossEntropy")),
				...
				var h = (function (t, e, i) {
					if (
						(void 0 === i && (i = -1), -1 === i && (i = e.rank - 1), i !== e.rank - 1)
					)
						throw Error(
	...
	function th(r, o) {
		return (
			...
			Kt.tidy(function () {
				if (2 !== r.shape.length)
					throw new Error(
						"qr2d() requires a 2D Tensor, but got a " + r.shape.length + "D Tensor."
					);
				for (
					var p = r.shape[0],
						d = r.shape[1],
						...
						e = function (f) {
							...
							(y = (t = Kt.tidy(function () {
								...
								y =
									1 === i.shape[0]
										? g.clone()
										: g.concat(i.slice([1, 0], [i.shape[0] - 1, i.shape[1]]), 0);
				...
				return (
					!o &&
						d < p &&
						((v = v.slice([0, 0], [p, d])), (m = m.slice([0, 0], [d, d]))),
					[v, m]
				);
			})
		);
		...
		rh = wn({
			qr_: function (t, o) {
				if ((void 0 === o && (o = !1), t.rank < 2))
					throw new Error(
						"qr() requires input tensor to have a rank >= 2, but got rank " + t.rank
					);
				...
				var e = t.shape.slice(0, t.shape.length - 2).reduce(function (t, e) {
					...
					n = Br(
						t.reshape([e, t.shape[t.shape.length - 2], t.shape[t.shape.length - 1]]),
						0
					),
					i = [],
					a = [];
	...
	var lh = wn({
			resizeBilinear_: function (t, e, r) {
				...
				P(3 === n.rank || 4 === n.rank, function () {
					...
					P(2 === e.length, function () {
						return (
							"Error in resizeBilinear: new shape must 2D, but got shape " + e + "."
						);
					});
				var o = n,
					i = !1;
					...
					y(this, void 0, void 0, function () {
						...
						return R(this, function (t) {
							switch (t.label) {
								case 0:
									return (
										(e = cn(u, "boxes", "nonMaxSuppressionAsync")),
										(n = cn(c, "scores", "nonMaxSuppressionAsync")),
										(r = ih(e, n, l, h, f)),
										(l = r.maxOutputSize),
										(h = r.iouThreshold),
										(f = r.scoreThreshold),
		...
		mh = wn({
			fusedMatMul_: function (t) {
				...
				null != c &&
					go(I, (E = Lt((E = cn(c, "bias", "fused matMul")), p)[0]).shape),
					null != h && (_ = cn(h, "prelu weights", "fused matMul"));
				var S = { a: R, b: k };
		...
		gh = wn({
			fusedConv2d_: function (t) {
				...
				null != h &&
					((x = Lt((x = cn(h, "bias", "fused conv2d")), v)[0]),
					go(w.outShape, x.shape)),
					null != p && (b = cn(p, "prelu weights", "fused conv2d"));
				var C = { x: g, filter: m };
		...
		yh = wn({
			fusedDepthwiseConv2d_: function (t) {
				...
				null != l &&
					((x = Lt((x = cn(l, "bias", "fused conv2d")), v)[0]),
					go(w.outShape, x.shape)),
					null != p && (b = cn(p, "prelu weights", "fused depthwiseConv2d"));
				var C = { x: g, filter: m };
		...
		_h =
			...
			(Ih.prototype.readSync = function (t) {
				var e = this.data.get(t),
					...
					r = e.complexTensors;
				return "complex64" === n
					? Mo(this.readSync(r.real.dataId), this.readSync(r.imag.dataId))
			...
			(Ih.prototype.slice = function (t, n, e) {
				...
				for (
					var i = cr(e, t.dtype), a = this.bufferSync(t), s = 0;
					s < i.size;
					++s
				) {
			...
			(Ih.prototype.stridedSlice = function (t, e, n, r) {
				...
				if (
					...
					return In([], o);
				for (
					var i = cr(o, t.dtype), a = this.bufferSync(t), s = 0;
					s < i.size;
					s++
				) {
					for (
			...
			(Ih.prototype.batchMatMul = function (t, e, n, r) {
				...
				for (
					var o = n ? t.shape[1] : t.shape[2],
						...
						l = n ? [t.strides[0], 1, t.strides[1]] : [t.strides[0], t.strides[1], 1],
						h = l[0],
						f = l[1],
						p = l[2],
						d = r ? [1, e.strides[1], e.strides[0]] : [e.strides[1], 1, e.strides[0]],
						v = d[0],
						m = d[1],
						g = d[2],
						y = i * a,
			...
			(Ih.prototype.select = function (t, e, n) {
				...
				for (
					var r = this.readSync(t.dataId),
						...
						a = Pn(e.shape, Pt(e.dtype, n.dtype)),
						s = this.readSync(a.dataId),
						u = 0,
						c = 0 === t.rank || 1 < t.rank || 1 === e.rank ? 1 : L(e.shape.slice(1)),
						l = 0;
					l < r.length;
					l++
				)
			...
			(Ih.prototype.ceil = function (t) {
				wh(t, "ceil");
				for (
					var e = this.readSync(t.dataId), n = new Float32Array(e.length), r = 0;
					r < e.length;
					++r
				)
					n[r] = Math.ceil(e[r]);
			...
			(Ih.prototype.selu = function (t) {
				...
				for (
					...
					var o = n[r];
					e[r] =
						0 <= o ? 1.0507009873554805 * o : 1.7580993408473768 * (Math.exp(o) - 1);
				}
				return this.makeOutput(e, t.shape, "float32");
			}),
				...
				for (
					...
					for (var E = C * h, _ = C * v, I = 0; I < n.outHeight; ++I)
						for (var R = _ + I * m, k = I * n.strideHeight - u, S = 0; S < r; S++) {
							...
							if (!(D < 0 || D >= n.inHeight))
								for (
									var A = S * e.strides[0], T = E + D * f, N = 0;
									N < n.outWidth;
									++N
								)
									for (var F = R + N * g, M = N * n.strideWidth - s, O = 0; O < o; O++) {
										...
										if (!(P < 0 || P >= n.inWidth))
											for (
												var B = T + P * p, L = A + O * e.strides[1], W = 0;
												W < n.inChannels;
												++W
											) {
												for (var z = x[B + W * d], U = 0; U < n.outChannels; ++U)
													w[F + U * y] += z * b[L + U];
												L += n.outChannels;
											}
									}
			...
			(Ih.prototype.conv3d = function (t, e, n) {
				for (
					...
					for (
						var g = m * t.strides[0], y = m * f.strides[0], x = 0;
						x < n.outDepth;
						++x
					)
						for (
							var b = y + x * f.strides[1], w = x * n.strideDepth - c, C = 0;
							C < r;
							C++
						) {
							var E = w + C * a;
							if (!(E < 0 || E >= n.inDepth))
								for (
									...
									for (
										var k = b + R * f.strides[2], S = R * n.strideHeight - h, D = 0;
										D < o;
										D++
									) {
										var A = S + D * s;
										if (!(A < 0 || A >= n.inHeight))
											for (
												var T = _ + D * e.strides[1], N = I + A * t.strides[2], F = 0;
												F < n.outWidth;
												++F
											)
												for (
													var M = k + F * n.outChannels, O = F * n.strideWidth - l, P = 0;
													P < i;
													P++
												) {
													var B = O + P * u;
													if (!(B < 0 || B >= n.inWidth))
														for (
															...
															for (var V = p[W + U], G = 0; G < n.outChannels; ++G)
																v[M + G] += V * d[z + G];
															z += n.outChannels;
														}
												}
								...
								for (var w = 0, C = 0; C < n.batchSize; ++C)
									for (var E = d; E < v; ++E)
										for (var _ = p + E * r - l, I = g; I < y; ++I) {
											var R = m + I * o - c;
											w += s
												? h.get(C, _, R, x) * f.get(C, E, I, b)
												: h.get(C, x, _, R) * f.get(C, b, E, I);
										}
								u.set(w, p, m, x, b);
							}
				return u.toTensor();
									...
									for (var j = 0, K = 0; K < n.batchSize; ++K)
										for (var X = K * _, Y = K * y, $ = N; $ < F; ++$)
											for (
												...
												for (
													var tt = (O + Z * o - A) * R + J, et = Z * b + Q, nt = z;
													nt < U;
													++nt
												) {
													var rt = nt * w + et;
						...
						for (
							...
							if (!(w < 0 || w >= n.inHeight))
								for (
									...
									for (
										var I = y + _ * l.strides[2], R = _ * n.strideWidth - u, k = 0;
										k < o;
										++k
									) {
										var S = R + k * a;
			...
			(Ih.prototype.gather = function (t, e, n) {
				...
				r[n] = o.length;
				for (
					var i = cr(r, t.dtype), a = this.bufferSync(t), s = 0;
					s < i.size;
					++s
				) {
					var u = i.indexToLoc(s),
												...
												if (!(N < 0 || N >= r.outHeight || Math.floor(N) !== N))
													for (var F = 0; F < p; F += l) {
														...
														if (!(M < 0 || M >= r.outWidth || Math.floor(M) !== M)) {
															var O =
																h * f * p - 1 - y.get(b, A, N, M, w) === D * f * p + T * p + F
																	? 1
																	: 0;
				...
				for (
					...
					for (var g = m * t.strides[0], y = 0; y < e; y++)
						for (
							var x = p * y,
								b =
									g + Math.min(a - 1, r ? Math.round(x) : Math.floor(x)) * t.strides[1],
								w = 0;
							w < n;
							w++
						)
							for (
								var C = d * w,
									E =
										b + Math.min(s - 1, r ? Math.round(C) : Math.floor(C)) * t.strides[2],
									_ = 0;
								_ < u;
								_++
							) {
											...
											for (var B = 0; B < b; B++) {
												...
												if (!(L < 0 || l <= L)) {
													var W = O + L * t.strides[2],
														z = L * m;
													k === Math.min(a - 1, n ? Math.round(z) : Math.floor(z)) &&
														(N += f[W + T]);
												}
											}
									}
			...
			(Ih.prototype.nonMaxSuppression = function (t, e, n, r, o) {
				return (
					wh(t, "nonMaxSuppression"),
					Bo(this.readSync(t.dataId), this.readSync(e.dataId), n, r, o)
				);
			}),
			...
			(Ih.prototype.fftBatch = function (t, e) {
				for (
					var n = t.shape[0],
						r = t.shape[1],
						o = cr(t.shape, "float32"),
						i = cr(t.shape, "float32"),
						a = En(t).as2D(n, r),
						s = _n(t).as2D(n, r),
						u = 0;
					u < n;
			...
			(Ih.prototype.fftRadix2 = function (t, e, n) {
				...
				var c = (function (t, e) {
						for (
							var n = new Float32Array(t / 2), r = new Float32Array(t / 2), o = 0;
							o < Math.ceil(t / 2);
							o++
						) {
					...
					if (!(s <= R))
						for (
							...
							if (A < 0 || u - 1 < A)
								...
								for (T = 0; T < p; T++)
									if (
										(q = 1 < p ? E * (c - 1) + T * S : 0.5 * (E + I) * (c - 1)) < 0 ||
										c - 1 < q
									)
										for (N = 0; N < l; N++)
											(F = N + T * x[2] + D * x[1] + b * x[0]), (d.values[F] = i);
									else {
										var B = Math.floor(q),
											L = Math.ceil(q),
											W = q - B;
			...
			(Ih.prototype.scatter = function (t, e, n, r, o, i, a, s, u, c) {
				...
				for (var d = 0; d < i; d++) {
					...
					for (var x = 0; x < o; x++)
						c
							? (p.values[m * o + x] += f[d * o + x])
							: (p.values[m * o + x] = 0 === e.rank ? f[0] : f[d * o + x]);
				}
							...
							c = (function (t, e, a, s, n, u) {
								...
								if (m.length + g.length === 0)
									for (var o = 0; o < h.length; ++o)
										h[o] = u(a[o % a.length], s[o % s.length]);
								else {
									var i = function (t) {
										var e = it(t, c, l),
											n = e.slice(-f);
			...
			Nh = [
				{
					...
					kernelFunc: function (t) {
						var e = t.inputs,
							...
							i = r.numChannels,
							a =
								"undefined" != typeof HTMLVideoElement && o instanceof HTMLVideoElement,
							s =
								"undefined" != typeof HTMLImageElement && o instanceof HTMLImageElement,
							...
							f = [l, c, i];
						(s || a) &&
							(null == Sh && (Sh = document.createElement("canvas").getContext("2d")),
							(Sh.canvas.width = c),
							(Sh.canvas.height = l),
							Sh.drawImage(o, 0, 0, c, l),
							(o = Sh.canvas));
						var p = n.makeTensorInfo(h, "int32");
						(n.texData.get(p.dataId).usage = Jt.PIXELS),
							n.gpgpu.uploadPixelDataToTexture(n.getTexture(p.dataId), o);
				...
				},
				{
					...
					kernelFunc: function (t) {
						var e = t.inputs,
							...
							i = r.b,
							a = n,
							s = _().getBool("WEBGL_PACK_BINARY_OPERATIONS")
								? new di("return (a - b) * (a - b);", o.shape, i.shape)
								: new pi("return (a - b) * (a - b);", o.shape, i.shape);
		...
		Lh =
			((Wh.prototype.fetch = function (t, e) {
				return null != _().global.fetch
					? _().global.fetch(t, e)
					: (null == Bh && (Bh = require("node-fetch")), Bh(t, e));
			}),
	...
	var Xh =
			...
			(Qh.getHandlers = function (n, t, r) {
				...
				return (
					("load" === t
						? Qh.getInstance().loadRouters
						: Qh.getInstance().saveRouters
					).forEach(function (t) {
						var e = t(n, r);
						null !== e && o.push(e);
					}),
			...
			y(this, void 0, void 0, function () {
				...
				return R(this, function (t) {
					switch (t.label) {
						...
						case 1:
							return (
								(u = t.sent()), f && s ? [4, $h.getManager(i).removeModel(a)] : [3, 3]
							);
						case 2:
							t.sent(), (t.label = 3);
						case 3:
						...
						case 4:
							return (
								(c = t.sent()), !f || s ? [3, 6] : [4, $h.getManager(i).removeModel(a)]
							);
						case 5:
							t.sent(), (t.label = 6);
						case 6:
	...
	function of(t) {
		var e = t.result;
		e.createObjectStore(ef, { keyPath: "modelPath" }),
			e.createObjectStore(nf, { keyPath: "modelPath" });
	}
	function af(t) {
		return _().getBool("IS_BROWSER") &&
			!Array.isArray(t) &&
			t.startsWith(sf.URL_SCHEME)
			? ((e = t.slice(sf.URL_SCHEME.length)), new sf(e))
			: null;
		var e;
	}
	var sf =
							...
							(e.onsuccess = function () {
								if (null == e.result)
									return (
										...
										c(
											new Error(
												"Cannot find model with path '" + f.modelPath + "' in IndexedDB."
											)
										)
									);
		...
		(lf.prototype.removeModel = function (u) {
			return y(this, void 0, void 0, function () {
				...
				return R(this, function (t) {
					var e;
					return (
						(u = (e = u).startsWith(sf.URL_SCHEME)
							? e.slice(sf.URL_SCHEME.length)
							: e),
						[
							2,
										...
										(i.onsuccess = function () {
											if (null == i.result)
												return (
													r.close(),
													s(
														new Error("Cannot find model with path '" + u + "' in IndexedDB.")
													)
												);
											function e() {
												var t = (n = r.transaction(ef, "readwrite"))
													.objectStore(ef)
													.delete(u);
	...
	function bf(t) {
		return _().getBool("IS_BROWSER") &&
			!Array.isArray(t) &&
			t.startsWith(wf.URL_SCHEME)
			? ((e = t.slice(wf.URL_SCHEME.length)), new wf(e))
			: null;
		var e;
	}
	var wf =
		...
		(Cf.prototype.load = function () {
			return y(this, void 0, void 0, function () {
				...
				return R(this, function (t) {
					...
					if (
						((n = {}), null == (r = JSON.parse(this.LS.getItem(this.keys.topology))))
					)
						throw new Error(
	...
	var Ef =
		((_f.prototype.listModels = function () {
			return y(this, void 0, void 0, function () {
				var e, n, r, o, i, a;
				return R(this, function (t) {
					for (e = {}, n = ff + hf, r = hf + pf, o = 0; o < this.LS.length; ++o)
						(i = this.LS.key(o)).startsWith(n) &&
							i.endsWith(r) &&
							((a = xf(i)), (e[a] = JSON.parse(this.LS.getItem(i))));
					return [2, e];
				});
			});
		}),
		(_f.prototype.removeModel = function (o) {
			return y(this, void 0, void 0, function () {
				...
				return R(this, function (t) {
					var e;
					if (
						((o = (e = o).startsWith(wf.URL_SCHEME)
							? e.slice(wf.URL_SCHEME.length)
							: e),
						(n = yf(o)),
					...
					return R(this, function (t) {
						switch (t.label) {
							...
							case 1:
								return (
									(n = [
										{ paths: ["./" + this.weightDataFileName], weights: s.weightSpecs },
									]),
									(r = {
													...
													e.forEach(function (t) {
														t.paths.forEach(function (r) {
															...
															(t.onload = function (t) {
																...
																(t.onerror = function (t) {
																	return l(
																		"Failed to weights data from file of path '" + r + "'."
																	);
																}),
	...
	function Df(t) {
		...
		t.startsWith(Df.URL_SCHEME) && (t = t.slice(Df.URL_SCHEME.length)),
	...
	function Af(n, r, o, i) {
		...
		P(null != (a = n) && Array.isArray(a) && 0 < a.length, function () {
			...
			P(0 <= t && t <= 1, function () {
				return (
					"Progress fraction must be in range [0, 1], but got startFraction " + t
				);
			}),
			P(0 <= e && e <= 1, function () {
				return (
						...
						switch (t.label) {
									...
									p.forEach(function (t, o) {
										...
										t.weights.forEach(function (n) {
											function r() {
												(a[o] = !0),
													null == c[o] && (c[o] = []),
													c[o].push({ manifestEntry: n, groupOffset: i, sizeBytes: e });
											}
							...
							case 1:
								return (
									...
									(f = 0),
									n.forEach(function (t) {
										for (var e = p[t].paths.length, n = 0, r = 0; r < e; r++)
											n += l[f + r].byteLength;
										for (
											var o = new ArrayBuffer(n), i = new Uint8Array(o), a = 0, s = 0;
											s < e;
											s++
										) {
										...
										c[t].forEach(function (t) {
											var e = Vh(o.slice(t.groupOffset, t.groupOffset + t.sizeBytes), [
												t.manifestEntry,
											]);
	...
	Xh.registerSaveRouter(function (t) {
		return _().getBool("IS_BROWSER") &&
			!Array.isArray(t) &&
			t.startsWith(Rf.URL_SCHEME)
			? (void 0 === (e = t.slice(Rf.URL_SCHEME.length)) && (e = "model"),
			  new Rf(e))
			: null;
		var e;
	});
					...
					switch (t.label) {
						case 0:
							...
							return (
								...
								(n = [{ paths: ["./model.weights.bin"], weights: i.weightSpecs }]),
								(r = {
								...
								null != i.weightData &&
									e.body.append(
										"model.weights.bin",
										new Blob([i.weightData], { type: "application/octet-stream" }),
										"model.weights.bin"
									),
						...
						case 1:
							if ((o = t.sent()).ok)
								return [2, { modelArtifactsInfo: Kh(i), responses: [o] }];
							throw new Error(
					...
					switch (t.label) {
						case 0:
							for (
								...
								(f = h[l]), c.push.apply(c, f.weights);
							return (
								(p = []),
	...
	var Vf,
				...
				return y(this, void 0, void 0, function () {
					...
					return R(this, function (t) {
						switch (t.label) {
							...
							case 1:
								return r < o.length
									? ((i = o[r]), [4, $h.getManager(i).listModels()])
									: [3, 4];
							case 2:
		...
		jf = wn({
			fromPixels_: function (t, e) {
				...
				if (null != g("FromPixels", Kt.backendName))
					return Kt.runKernel("FromPixels", { pixels: t }, { numChannels: e });
				var s,
					u,
				...
				if (
					(a
						...
						? (s = t.data)
						: (i || o) &&
						  (null == Vf && (Vf = document.createElement("canvas").getContext("2d")),
						  (Vf.canvas.width = l),
						  (Vf.canvas.height = h),
						  Vf.drawImage(t, 0, 0, l, h),
						  (s = Vf.getImageData(0, 0, l, h).data)),
					4 === e)
				)
					u = new Int32Array(s);
				else {
					...
					for (var p = 0; p < f; p++)
						for (var d = 0; d < e; ++d) u[p * e + d] = s[4 * p + d];
				}
					...
					return R(this, function (t) {
						switch (t.label) {
							case 0:
								if (
									((e = cn(_, "img", "toPixels")),
									_ instanceof bt || (e = e.toInt()),
									2 !== e.rank && 3 !== e.rank)
								)
									throw new Error(
										"toPixels only supports rank 2 or 3 tensors, got rank " + e.rank + "."
									);
								if (
									((n = e.shape.slice(0, 2)),
									(r = n[0]),
	...
	function ep(t, e, n) {
		...
		if (Array.isArray(t) && Array.isArray(e)) {
			...
			if (!A(a, s))
				throw new Error(
					"Arrays have different shapes. Actual: [" + a + "]. Expected: [" + s + "]"
				);
		}
		var u = z(t) ? t : b(t),
			c = z(e) ? e : b(e);
				...
				return y(this, void 0, void 0, function () {
					return R(this, function (t) {
						return (
							...
							[2, { name: "iter", tensor: kn(this.iterations_, "int32") }]
						);
					});
				});
			}),
	...
	Object.defineProperty(ap, Symbol.hasInstance, {
		value: function (t) {
			return (
				null != t.minimize && null != t.computeGradients && null != t.applyGradients
			);
		},
	});
	var up,
	...
	function lp(t, e, n) {
		...
		return (
			...
			null == n && (r.epsilon = Kt.backend.epsilon()),
			r
		);
	}
	Qf(cp);
				...
				(Array.isArray(i)
					...
					if (null != r) {
						...
						nn(function () {
							...
							o.assign(t);
							var e = r
								.div(t.add(Kt.backend.epsilon()).sqrt())
								.mul(-a.learningRate)
								.add(n);
							n.assign(e);
						});
				...
				return y(this, void 0, void 0, function () {
					...
					return R(this, function (t) {
						switch (t.label) {
							case 0:
								return (
									(e = this.accumulatedFirstMoment.concat(this.accumulatedSecondMoment)),
									[4, this.saveIterations()]
								);
							case 1:
								return [
						...
						switch (t.label) {
							...
							case 1:
								return (
									(r = t.sent()),
									nn(function () {
										n.accBeta1.assign(Ju(n.beta1, n.iterations_ + 1)),
											n.accBeta2.assign(Ju(n.beta2, n.iterations_ + 1));
									}),
									(e = r.length / 2),
							...
							if (h.centered) {
								var e = h.accumulatedMeanGrads[a].variable,
									...
									r = l
										.mul(h.momentum)
										.add(
											u.mul(h.learningRate).div(t.sub(n.square().add(h.epsilon)).sqrt())
										);
	...
	var id =
		...
		(ad.prototype.toSquare = function () {
			...
			return (
				n < r && ((t -= o / 2), (n += o)),
				r < n && ((e -= o / 2), (r += o)),
				new ad({ x: t, y: e, width: n, height: r })
			);
		}),
	...
	function cd(t, e, n, r, o) {
		return (
			void 0 === o && (o = !1),
			sd.call(this, { left: t, top: e, right: n, bottom: r }, o) || this
		);
	}
	var ld =
	...
	function hd(t, e, n, r, o) {
		(this._imageDims = new Up(o.width, o.height)),
			(this._score = t),
			(this._classScore = e),
			(this._className = n),
			(this._box = new id(r).rescale(this._imageDims));
	}
	var fd,
		pd =
			(Pp(dd, (fd = ld)),
	...
	function Ed(t, e, n, r, o) {
		return (
			void 0 === o && (o = !1),
			wd.call(this, { x: t, y: e, width: n, height: r }, o) || this
		);
	}
	var _d =
	...
	var Md,
		Od =
			...
			(Pd.assertIsValidLabeledBox = function (t, e) {
				if ((id.assertIsValidBox(t, e), !td(t.label)))
					throw new Error(
	...
	var Wd,
		...
		Ud =
			...
			(Vd.assertIsValidPredictedBox = function (t, e) {
				if ((Od.assertIsValidLabeledBox(t, e), !ed(t.score) || !ed(t.classScore)))
					throw new Error(
						e +
	...
	function jd(e) {
		...
		return {
			readFile: e
				...
				: function () {
						throw new Error(
							"readFile - failed to require fs in nodejs environment with error: " + n
						);
				  },
		};
	}
	...
	Jd(),
		((Zd = Qd = Qd || {}).TOP_LEFT = "TOP_LEFT"),
		(Zd.TOP_RIGHT = "TOP_RIGHT"),
		(Zd.BOTTOM_LEFT = "BOTTOM_LEFT"),
		(Zd.BOTTOM_RIGHT = "BOTTOM_RIGHT");
	var rv = function (t) {
			void 0 === t && (t = {});
			var e = t.anchorPosition,
				...
				i = t.fontStyle,
				a = t.padding;
			(this.anchorPosition = e || Qd.TOP_LEFT),
	...
	function iv(t, e, n) {
		void 0 === n && (n = {}),
			(this.text = "string" == typeof t ? [t] : t instanceof iv ? t.text : t),
			(this.anchor = e),
			(this.options = new rv(n));
	}
	var av = function (t) {
			void 0 === t && (t = {});
			var e = t.boxColor,
		...
		sv =
			((uv.prototype.draw = function (t) {
				...
				l &&
					new ov([l], { x: a - o / 2, y: s }, this.options.drawLabelOptions).draw(t);
			}),
			uv);
	function uv(t, e) {
	...
	function fv(t) {
		...
		return t instanceof n
			? new Up(t.naturalWidth, t.naturalHeight)
			: t instanceof r
			? new Up(t.videoWidth, t.videoHeight)
			: new Up(t.width, t.height);
	}
	function pv(t) {
		var e = t.width,
			n = t.height,
	...
	function dv(t, e) {
		...
		return (
			t instanceof n
				? nv(a).putImageData(t, 0, 0)
				: nv(a).drawImage(t, 0, 0, o, i),
			a
		);
	}
	function vv(s, u) {
				...
				nn(function () {
					var t = Zp(i.batchSize, 0, 1).map(function (t) {
						...
						if (e instanceof bt) {
							...
							return (
								((n = xd(n, o)).shape[1] === r && n.shape[2] === r) ||
									(n = vh.resizeBilinear(n, [r, r])),
								n.as3D(r, r, 3)
							);
						}
	...
	function xv(t, e) {
		...
		(this._treatAsBatchInput = e),
			...
			t.forEach(function (t, e) {
				if (qp(t))
					return (o._imageTensors[e] = t), void (o._inputDimensions[e] = t.shape);
				if (jp(t)) {
					var n = t.shape[0];
					if (1 !== n)
						throw new Error(
					...
					return (
						(o._imageTensors[e] = t), void (o._inputDimensions[e] = t.shape.slice(1))
					);
				}
		...
		return Lp(this, void 0, void 0, function () {
			...
			return Wp(this, function (t) {
				switch (t.label) {
					case 0:
						return (
							(e = tv.getEnv().Canvas), (n = s) instanceof e ? [3, 5] : [4, bv(s)]
						);
					case 1:
		...
		return Lp(this, void 0, void 0, function () {
			...
			return Wp(this, function (t) {
				switch (t.label) {
					case 0:
						return (
							(e = Iv(i, a)), (n = e.manifestUri), (r = e.modelBaseUri), [4, _v(n)]
						);
					case 1:
	...
	function Av(r, o, i) {
		return (
			...
			nn(function () {
				var t = dl(
						i
							? Ou(Ec(r, o.conv0.filters, [2, 2], "same"), o.conv0.bias)
							: Dv(r, o.conv0, [2, 2])
					),
					e = Dv(t, o.conv1, [1, 1]),
	...
	function Tv(o, i, a, s) {
		return (
			...
			nn(function () {
				var t = dl(
						a
							? Ou(Ec(o, i.conv0.filters, s ? [2, 2] : [1, 1], "same"), i.conv0.bias)
							: Dv(o, i.conv0, s ? [2, 2] : [1, 1])
					),
					e = Dv(t, i.conv1, [1, 1]),
	...
	function Wv(o, i) {
		return function (t, e, n) {
			...
			if (!Gp(r, e))
				throw new Error(
					"expected weightMap[" + t + "] to be a Tensor" + e + "D, instead have " + r
				);
	...
	var Hv,
		qv =
			...
			(jv.prototype.forwardInput = function (e) {
				...
				return nn(function () {
					var t = Tv(
						yd(e.toBatchTensor(112, !0), [122.782, 117.001, 104.298]).div(kn(255)),
						n.dense0,
						!0
					);
					return (
						(t = Tv((t = Tv((t = Tv(t, n.dense1)), n.dense2)), n.dense3)),
						(t = Hc(t, [7, 7], [2, 2], "valid"))
					);
				});
			}),
		...
		$v =
			...
			(Jv.prototype.dispose = function (t) {
				void 0 === t && (t = !0),
					...
					Yv.prototype.dispose.call(this, t);
			}),
	...
	function rm(t) {
		return (
			void 0 === t && (t = new qv()), em.call(this, "FaceExpressionNet", t) || this
		);
	}
	function om(t) {
	...
	function am(t) {
		return (
			Gd(t) &&
			t.landmarks instanceof _d &&
			t.unshiftedLandmarks instanceof _d &&
			t.alignedRect instanceof pd
		);
	}
	function sm(t, e) {
		...
		cm =
			((lm.prototype.draw = function (t) {
				var e = nv(t),
					...
					u = n.pointColor;
				r &&
					this.faceLandmarks instanceof Ad &&
					((e.strokeStyle = a),
					(e.lineWidth = i),
					Mp(e, this.faceLandmarks.getJawOutline()),
					Mp(e, this.faceLandmarks.getLeftEyeBrow()),
					Mp(e, this.faceLandmarks.getRightEyeBrow()),
					Mp(e, this.faceLandmarks.getNose()),
					Mp(e, this.faceLandmarks.getLeftEye(), !0),
					Mp(e, this.faceLandmarks.getRightEye(), !0),
					Mp(e, this.faceLandmarks.getMouth(), !0)),
					o &&
						((e.strokeStyle = u),
						(e.fillStyle = u),
	...
	function pm(t, e) {
		...
		return (
			Fv(t, n),
			{ params: { entry_flow: u, middle_flow: c, exit_flow: l }, paramMappings: n }
		);
	}
	function dm(t, e, n) {
	...
	function vm(t, e, n) {
		...
		var r = n ? dl(t) : t;
		return (
			(r = Dv(r, e.separable_conv0, [1, 1])),
			(r = Dv(dl(r), e.separable_conv1, [1, 1])),
			(r = Gc(r, [3, 3], [2, 2], "same")),
			(r = Ou(r, dm(t, e.expansion_conv, [2, 2])))
		);
	}
	var mm,
		gm,
		ym =
			...
			(xm.prototype.forwardInput = function (n) {
				...
				return nn(function () {
					var t = yd(n.toBatchTensor(112, !0), [122.782, 117.001, 104.298]).div(
							kn(256)
						),
						e = dl(dm(t, o.entry_flow.conv_in, [2, 2]));
					return (
						(e = vm(
							(e = vm(e, o.entry_flow.reduction_block_0, !1)),
						...
						Zp(r._numMainBlocks, 0, 1).forEach(function (t) {
							e = (function (t, e) {
								...
								return (
									(n = Dv(dl(n), e.separable_conv1, [1, 1])),
									(n = Dv(dl(n), e.separable_conv2, [1, 1])),
									(n = Ou(n, t))
								);
	...
	var bm,
		wm =
														...
														switch (t.label) {
															...
															case 2:
																return (
																	...
																	a.dispose(),
																	s.dispose(),
																	[2, { age: e, gender: o, genderProbability: i }]
																);
														}
													});
												});
			...
			(Cm.prototype.dispose = function (t) {
				void 0 === t && (t = !0),
					this.faceFeatureExtractor.dispose(t),
					bm.prototype.dispose.call(this, t);
			}),
	...
	function Sm(t) {
		return (
			void 0 === t && (t = new qv()), Rm.call(this, "FaceLandmark68Net", t) || this
		);
	}
	var Dm,
		Am =
			...
			(Tm.prototype.forwardInput = function (e) {
				...
				return nn(function () {
					...
					return (
						(t = Av((t = Av(t, n.dense1)), n.dense2)),
						(t = Hc(t, [14, 14], [2, 2], "valid"))
					);
				});
			}),
	...
	function Mm(t) {
		return (
			void 0 === t && (t = new Am()),
			Nm.call(this, "FaceLandmark68TinyNet", t) || this
		);
	}
	var Om,
		Pm = (Pp(Bm, (Om = km)), Bm);
	...
	var qm,
		jm =
			...
			(Km.prototype.forwardInput = function (n) {
				...
				return nn(function () {
					var t = zm(
							yd(n.toBatchTensor(150, !0).toFloat(), [122.782, 117.001, 104.298]).div(
								kn(256)
							),
							r.conv32_down
						),
														...
														(t = Gm(
															(t = Gm(
																(t = Hm(
																	(t = Gm(
																		(t = Gm(
																			(t = Gm((t = Gc(t, 3, 2, "valid")), r.conv32_1)),
																			r.conv32_2
																		)),
																		r.conv32_3
																	)),
			...
			(Km.prototype.extractParamsFromWeigthMap = function (t) {
				return (function (t) {
					var e = [],
						...
						b = t.fc;
					if ((e.push({ originalPath: "fc", paramPath: "fc" }), !Hp(b)))
						throw new Error(
	...
	function tg(t) {
		...
		if (
			...
			throw new Error(
				"expected weightMap['Output/extra_dim'] to be a Tensor3D, instead have " + i
			);
		var a = {
			mobilenetv1: r(),
			prediction_layer: o(),
	...
	function ig(t, e) {
		var n = (function (t) {
				...
				return {
					sizes: n,
					centers: [Ou(e[0], Wu(n[0], kn(2))), Ou(e[1], Wu(n[1], kn(2)))],
				};
			})(t),
			r = n.sizes,
			o = n.centers,
		...
		lg =
					...
					Lp(this, void 0, void 0, function () {
						...
						return Wp(this, function (t) {
							switch (t.label) {
								case 0:
									return (
										(e = new sg(C)), (n = e.maxResults), (r = e.minConfidence), [4, bv(w)]
									);
								case 1:
									for (
										s = t.sent(),
								...
								case 2:
									return (
												...
												r.forEach(function (t) {
													if (!(u.length >= s)) {
														for (var e = t.score, n = u.length - 1; 0 <= n; --n) {
															...
															if (0 !== r && ((t.score *= r <= i ? 1 : 0), t.score <= a))
																break;
														}
										...
										(x = u.arraySync()),
										(b = d.map(function (t) {
											var e = [Math.max(0, x[t][0]), Math.min(1, x[t][2])].map(function (
													t
												) {
													return t * y;
												}),
			...
			(hg.prototype.extractParams = function (t) {
				return (function (t) {
					...
					if ((e.push({ paramPath: "output_layer/extra_dim" }), 0 !== o().length))
						throw new Error("weights remaing after extract: " + o().length);
					return {
	...
	var mg,
		gg = [
			new rd(0.738768, 0.874946),
			new rd(2.42204, 2.65704),
			new rd(4.30971, 7.04493),
			new rd(10.246, 4.59428),
			new rd(12.6868, 11.8741),
		],
		yg = [
			new rd(1.603231, 2.094468),
			new rd(6.041143, 7.080126),
			new rd(2.882459, 3.518061),
			new rd(4.266906, 5.178857),
			new rd(9.041765, 10.66308),
		],
	...
	function wg(t) {
		...
		if (!bg(t.iouThreshold) || t.iouThreshold < 0 || 1 < t.iouThreshold)
			throw new Error(
		...
		if (
			t.meanRgb &&
			(!Array.isArray(t.meanRgb) || 3 !== t.meanRgb.length || !t.meanRgb.every(bg))
		)
			throw new Error(
	...
	function Eg(e, n) {
		return nn(function () {
			...
			return (
				(t = Ec(t, n.conv.filters, [1, 1], "valid")),
				(t = tc(t, n.bn.sub)),
				(t = Yu(t, n.bn.truediv)),
				Cg((t = Ou(t, n.conv.bias)))
			);
		});
	}
	function _g(e, n) {
		return nn(function () {
			...
			return (
				(t = Ac(t, n.depthwise_filter, n.pointwise_filter, [1, 1], "valid")),
				Cg((t = Ou(t, n.bias)))
			);
		});
	}
	...
	((mg = c.TinyYolov2SizeType || (c.TinyYolov2SizeType = {}))[(mg.XS = 224)] =
		"XS"),
		(mg[(mg.SM = 320)] = "SM"),
		(mg[(mg.MD = 416)] = "MD"),
		(mg[(mg.LG = 608)] = "LG");
	...
	var Dg,
		Ag =
			...
			(Tg.prototype.runTinyYolov2 = function (t, e) {
				var n = Eg(t, e.conv0);
				return (
					(n = Eg((n = Gc(n, [2, 2], [2, 2], "same")), e.conv1)),
					(n = Eg((n = Gc(n, [2, 2], [2, 2], "same")), e.conv2)),
					(n = Eg((n = Gc(n, [2, 2], [2, 2], "same")), e.conv3)),
					(n = Eg((n = Gc(n, [2, 2], [2, 2], "same")), e.conv4)),
					(n = Eg((n = Gc(n, [2, 2], [2, 2], "same")), e.conv5)),
					Nv(
						(n = Eg((n = Eg((n = Gc(n, [2, 2], [1, 1], "same")), e.conv6)), e.conv7)),
						e.conv8,
						"valid",
						!1
					)
			...
			(Tg.prototype.runMobilenet = function (t, e) {
				var n = this.config.isFirstLayerConv2d
					? Cg(Nv(t, e.conv0, "valid", !1))
					: _g(t, e.conv0);
				return (
					(n = _g((n = Gc(n, [2, 2], [2, 2], "same")), e.conv1)),
					(n = _g((n = Gc(n, [2, 2], [2, 2], "same")), e.conv2)),
					(n = _g((n = Gc(n, [2, 2], [2, 2], "same")), e.conv3)),
					(n = _g((n = Gc(n, [2, 2], [2, 2], "same")), e.conv4)),
					(n = _g((n = Gc(n, [2, 2], [2, 2], "same")), e.conv5)),
					(n = Gc(n, [2, 2], [1, 1], "same")),
					(n = e.conv6 ? _g(n, e.conv6) : n),
					Nv((n = e.conv7 ? _g(n, e.conv7) : n), e.conv8, "valid", !1)
				);
			}),
			(Tg.prototype.forwardInput = function (e, n) {
				...
				return nn(function () {
					...
					return (
						(t = (t = r.config.meanRgb ? yd(t, r.config.meanRgb) : t).div(kn(256))),
					...
					Lp(this, void 0, void 0, function () {
						...
						return Wp(this, function (t) {
							switch (t.label) {
								case 0:
									return (
										(e = new kg(v)), (n = e.inputSize), (r = e.scoreThreshold), [4, bv(d)]
									);
								case 1:
						...
						switch (t.label) {
								...
								return (
									...
									(u = nn(function () {
										...
										return [
											...
											A.withClassScores
												? so(t.slice([0, 0, 0, 5], [a, a, s, A.config.classes.length]), 3)
												: kn(0),
										];
									})),
									(c = u[0]),
							...
							case 5:
								return g < s
									? ((y = bd(p[v][m][g][0])),
									  !F || F < y
											? ((x = ((m + bd(d[v][m][g][0])) / a) * o),
											  (b = ((v + bd(d[v][m][g][1])) / a) * i),
											  (w =
													((Math.exp(d[v][m][g][2]) * this.config.anchors[g].x) / a) * o),
											  (C =
													((Math.exp(d[v][m][g][3]) * this.config.anchors[g].y) / a) * i),
											  (E = x - w / 2),
											  (_ = b - C / 2),
							...
							case 1:
								return [
									...
									t.sent().map(function (t) {
										return new pd(t.score, t.relativeBox, {
											width: t.imageWidth,
	...
	function Mg(t) {
		...
		var e = Object.assign(
			...
			t ? { anchors: yg, meanRgb: xg } : { anchors: gg, withClassScores: !0 }
		);
	...
	function Qg(e, n, r) {
		return (
			...
			nn(function () {
				...
				return (
					(t = Jg(t, n.prelu1_alpha)),
					(t = Jg(
						(t = Nv(
							(t = Gc(t, r ? [2, 2] : [3, 3], [2, 2], "same")),
							n.conv2,
							"valid"
						)),
						n.prelu2_alpha
					...
					(t = Jg(
						(t = Nv((t = r ? t : Gc(t, [3, 3], [2, 2], "valid")), n.conv3, "valid")),
						n.prelu3_alpha
					))
				);
			})
						...
						i = (function (t, o, i, e) {
							for (var n = [], a = t.arraySync(), r = 0; r < t.shape[0]; r++)
								for (var s = 0; s < t.shape[1]; s++)
									a[r][s] >= e && n.push(new rd(s, r));
							return n.map(function (t) {
								var e = new ud(
										Math.round((t.y * Vg + 1) / i),
										Math.round((t.x * Vg + 1) / i),
										Math.round((t.y * Vg + Gg) / i),
										Math.round((t.x * Vg + Gg) / i)
									),
									n = a[t.y][t.x],
									r = o.arraySync();
								return {
										...
										return Lp(n, void 0, void 0, function () {
											...
											return Wp(this, function (t) {
												return (
													...
													[2, tv.isNodejs() ? dv(u) : createImageBitmap(u)]
												);
											});
										});
									})
							...
							(r = n.map(function (t) {
								var e = (function (a, s) {
									return nn(function () {
										var t = Qg(a, s),
											e = Jg(
												Kv(Tr(t, [t.shape[0], s.fc1.weights.shape[0]]), s.fc1),
												s.prelu4_alpha
											),
											n = Kv(e, s.fc2_1),
											r = yr(il(n, 1), 1),
							...
							(i = n.map(function (t) {
								var e = (function (s, u) {
									return nn(function () {
										var t = Qg(s, u);
										t = Jg(
											(t = Nv((t = Gc(t, [2, 2], [2, 2], "same")), u.conv4, "valid")),
											u.prelu4_alpha
										);
										var e = Jg(
												Kv(Tr(t, [t.shape[0], u.fc1.weights.shape[0]]), u.fc1),
												u.prelu5_alpha
											),
											n = Kv(e, u.fc2_1),
											r = yr(il(n, 1), 1),
								...
								(d = v.map(function (r, o) {
									return Array(5)
										...
										.map(function (t, e) {
											...
											return new rd(
												n[0][e] * (f[o].width + 1) + f[o].left,
												n[0][e + 5] * (f[o].height + 1) + f[o].top
											);
										});
								}))),
				...
				return Lp(this, void 0, void 0, function () {
					return Wp(this, function (t) {
						return (
							...
							[2, ry.prototype.load.call(this, e)]
						);
					});
				});
			}),
			(iy.prototype.loadFromDisk = function (e) {
				return Lp(this, void 0, void 0, function () {
					return Wp(this, function (t) {
						return (
							console.warn("mtcnn is deprecated and will be removed soon"),
							[2, ry.prototype.loadFromDisk.call(this, e)]
						);
					});
				});
			}),
										...
										(w = b.boxes.map(function (e, t) {
											return sm(
												Hd(
													...
													new pd(
														b.scores[t],
														new Cd(e.left / c, e.top / u, e.width / c, e.height / u),
														{ height: u, width: c }
													)
												),
												new kd(
													b.points[t].map(function (t) {
														return t
															.sub(new rd(e.left, e.top))
															.div(new rd(e.width, e.height));
													}),
			...
			Object.defineProperty(ix.prototype, "landmarkNet", {
				get: function () {
					return this.useTinyLandmarkNet
						? vy.faceLandmark68TinyNet
						: vy.faceLandmark68Net;
				},
				enumerable: !0,
				configurable: !0,
			}),
	...
	var vx,
		mx =
					...
					return Wp(this, function (t) {
						switch (t.label) {
							case 0:
								return (
									(n = (e = this).input),
									(r = e.options) instanceof Jm ? [4, vy.mtcnn.forward(n, r)] : [3, 2]
								);
							case 1:
								return [
									2,
			...
			(gx.prototype.withFaceLandmarks = function (t) {
				return (
					void 0 === t && (t = !1),
					new sx(this.runAndExtendWithFaceDetections(), this.input, t)
				);
			}),
	...
	var yx,
		xx =
			...
			(bx.prototype.withFaceLandmarks = function (t) {
				return (
					void 0 === t && (t = !1),
					new lx(this.runAndExtendWithFaceDetection(), this.input, t)
				);
			}),
	...
	(c.AgeGenderNet = wm),
						...
						switch (t.label) {
							case 0:
								return (
									...
									[4, wx(e, new Jm(n)).withFaceLandmarks().withFaceDescriptors()]
								);
							case 1:
								return [2, t.sent()];
						}
						...
						switch (t.label) {
							case 0:
								return (
									...
									[4, wx(e, new kg(n)).withFaceLandmarks().withFaceDescriptors()]
								);
							case 1:
								return [2, t.sent()];
						}
		...
		(c.resizeResults = function e(t, n) {
			...
			return Gd(t)
				? Hd(t, t.detection.forSize(o, i))
				: t instanceof _d || t instanceof pd
				? t.forSize(o, i)
				: t;
		}),
		(c.resolveInput = ev),
